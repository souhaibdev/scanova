...
class MainWindow(QWidget):
    ...
    def _build_shell(self):
        ...
        self._title_layout.addWidget(self._app_title)
    ...
    def _rebuild_sidebar(self):
        ...
        if hasattr(self, "_nfc_status_lbl"):
            self._apply_shell_alignment()
    ...
    def _apply_shell_alignment(self):
        is_rtl = self._translator.current_language == "ar"
        ...
        self._header_layout.setDirection(horizontal_direction)
        self._title_layout.setDirection(horizontal_direction)
        self._status_layout.setDirection(horizontal_direction)

        for btn in self._nav_buttons.values():
            btn.setStyleSheet(f"text-align: {text_align};")
        ...
        self._lang_combo.setLayoutDirection(self._translator.qt_layout_direction)
        self._change_password_btn.setLayoutDirection(self._translator.qt_layout_direction)
        self._logout_btn.setLayoutDirection(self._translator.qt_layout_direction)
